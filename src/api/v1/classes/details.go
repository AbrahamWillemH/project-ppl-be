...
// @Router /api/v1/classes/assign-teachers [delete]
func ClassAssignTeacherHandler(c *gin.Context) {
...
// ClassUnassignTeacherHandler unassign a teacher
// @Summary Unassig a Teacher in a Class
// @Description Deletes a class from the database by ID
// @Tags Classes
// @Security BearerAuth
// @Accept  json
...
// @Param id query int true "Class ID"
// @Success 200 {object} map[string]string
// @Router /api/v1/classes/unassign-teachers [delete]
func ClassUnassignTeacherHandler(c *gin.Context) {
	// Extract `id` from query parameters
	idStr := c.Query("id")
	id, err := strconv.Atoi(idStr)
	if err != nil || id <= 0 {
